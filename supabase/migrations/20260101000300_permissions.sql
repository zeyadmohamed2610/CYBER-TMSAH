-- ===========================================================
-- Permissions - University Attendance System
-- Run order: 4 of 4
-- ===========================================================
...
REVOKE EXECUTE ON FUNCTION public.log_login_session()
  FROM PUBLIC, anon;
REVOKE EXECUTE ON FUNCTION public.update_session_expiry(UUID, TIMESTAMPTZ)
  FROM PUBLIC, anon;
REVOKE EXECUTE ON FUNCTION public.gps_distance_meters(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION)
  FROM PUBLIC, anon;
...
GRANT EXECUTE ON FUNCTION public.log_login_session()
  TO authenticated;
GRANT EXECUTE ON FUNCTION public.update_session_expiry(UUID, TIMESTAMPTZ)
  TO authenticated;
