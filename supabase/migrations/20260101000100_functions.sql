-- ===========================================================
-- Functions - University Attendance System
...
--    Supports: configurable duration, GPS coordinates, short_code, lecture linking, section.
...
BEGIN
  ...
  IF v_caller.role IN ('doctor', 'ta') AND v_session.subject_id IS DISTINCT FROM v_caller.subject_id THEN
    RAISE EXCEPTION 'permission_denied: doctors and TAs may only stop their assigned subject sessions';
  END IF;
...
--    Purges sessions expired more than 1 hour ago.
...
BEGIN
  ...
  -- Insert attendance with optional GPS coordinates
...
-- ─────────────────────────────────────────────
-- 11. GPS distance calculation (Haversine formula)
-- ─────────────────────────────────────────────
