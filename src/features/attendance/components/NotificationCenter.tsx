    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="fixed md:absolute left-2 md:left-auto right-2 md:right-0 top-14 md:top-12 z-50 w-[350px] md:w-96 max-w-[calc(100vw-1rem)] max-h-[70vh] overflow-hidden rounded-2xl border border-border bg-card shadow-2xl" role="dialog" aria-label="مركز الإشعارات">
