...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "النظام يعتمد على تحديد موقعك الجغرافي (GPS) بالقرب من القاعة،再加上 كود جلسة يظهر للدكتور ويتجدد كل 60 ثانية. عند إدخال الكود وتأكيد الموقع، يتم تسجيل حضورك تلقائياً. يمكنك أيضاً تسجيل الحضور حتى بدون إنترنت وسيتم المزامنة لاحقاً."
  },
  {
  ...
  {
    question: "ما هي الأدوار في المنصة وما الفرق بينها؟",
    answer: "يوجد 4 أدوار: المدير (الوصول الكامل للنظام)، الدكتور (إدارة محاضراته وجلسات الحضور)، المعيد (إدارة الأقسام الخاصة بمادته)، والطالب (عرض الجلسات النشطة وتسجيل الحضور). كل دور له لوحة تحكم مخصصة."
  },
  {
    question: "كيف أصل للجدول الدراسي؟",
    answer: "من خلال صفحة 'الجدول الدراسي' في القائمة الرئيسية. يمكنك اختيار سكشنك من القائمة المنسدلة وسترى الجدول الأسبوعي الكامل مع أسماء المواد والقاعة والمدرس لكل محاضرة."
  },
  {
  ...
  {
    question: "كيف أضيف إشعار أو تذكير لامتحان أو كويز؟",
    answer: "من خلال قسم 'الإشعارات' في لوحة التحكم، يمكنك إضافة موعد امتحان أو كويز مع تاريخ ووقت محدد. ستصلك تذكيرات تلقائية قبل الموعد، وحتى لو كنت غير متصل بالإنترنت."
  },
  {
